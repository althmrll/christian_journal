...
class PrayersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prayer" do
    assert_difference("Prayer.count") do
      post prayers_url, params: { prayer: { prayer: @prayer.prayer, specification: @prayer.specification } }
    end
  ...
  test "should update prayer" do
    patch prayer_url(@prayer), params: { prayer: { prayer: @prayer.prayer, specification: @prayer.specification } }
